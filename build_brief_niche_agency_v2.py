...
data_table(doc,
    ...
    [
        ...
        ("Social Media Management Pricing for Agencies",       "SocialPilot blog — agency pricing strategy"),
        ("White Label Social Media Management",                "SocialPilot white-label product page"),
        ("Social Media Agency Software",                       "SocialPilot features page for agencies"),
        ...
        ("SocialPilot for Agencies",                          "SocialPilot agency solutions landing page"),
    ]
)
